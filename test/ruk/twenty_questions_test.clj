...
(fact (identify (question-zip dr-who-question-bank)) => (answer? "Dr Who")
  (provided (ask "Are you a character from Dr Who?") => "Yes"))

(fact (identify (question-zip dr-who-question-bank)) => (answer? "Jimmy Carter")
  (provided (ask "Are you a character from Dr Who?") => "No"))

(fact (identify (question-zip question-bank)) => (answer? "Usain Bolt")
  (provided (ask "Are you a character from Dr Who?") => "No"
            (ask "Are you a famous athlete?") => "Yes"
            (ask "Are you a sprinter?") => "Yes"))

(fact (identify (question-zip question-bank)) => (answer? "Jimmy Carter")
  (provided (ask "Are you a character from Dr Who?") => "No"
            (ask "Are you a famous athlete?") => "No"))

(fact (identify (question-zip question-bank)) => (answer? "Michael Phelps")
  (provided (ask "Are you a character from Dr Who?") => "No"
            (ask "Are you a famous athlete?") => "Yes"
